package com.selfie.life.foldingcell.FoldingLibrary;
...
import com.selfie.life.foldingcell.FoldingLibrary.animations.AnimationEndListener;
import com.selfie.life.foldingcell.FoldingLibrary.animations.FoldAnimation;
import com.selfie.life.foldingcell.FoldingLibrary.animations.HeightAnimation;
import com.selfie.life.foldingcell.R;
...
public class FoldingCell extends RelativeLayout {
    ...
    public void unfold(boolean skipAnimation) {
        ...
        if (skipAnimation) {
            ...
            ArrayList<com.selfie.life.foldingcell.FoldingLibrary.animations.views.FoldingCellView> foldingCellElements = prepareViewsForAnimation(heights, bitmapFromTitleView, bitmapFromContentView);
     ...
     */
    protected ArrayList<com.selfie.life.foldingcell.FoldingLibrary.animations.views.FoldingCellView> prepareViewsForAnimation(ArrayList<Integer> viewHeights, Bitmap titleViewBitmap, Bitmap contentViewBitmap) {
        if (viewHeights == null || viewHeights.isEmpty())
            throw new IllegalStateException("ViewHeights array must be not null and not empty");

        ArrayList<com.selfie.life.foldingcell.FoldingLibrary.animations.views.FoldingCellView> partsList = new ArrayList<>();
        ...
        for (int i = 0; i < viewHeights.size(); i++) {
            ...
            partsList.add(new com.selfie.life.foldingcell.FoldingLibrary.animations.views.FoldingCellView(frontView, backView, getContext()));
     ...
     */
    protected void startFoldAnimation(ArrayList<com.selfie.life.foldingcell.FoldingLibrary.animations.views.FoldingCellView> foldingCellElements, ViewGroup foldingLayout,
                                      int part90degreeAnimationDuration, AnimationEndListener animationEndListener) {
        for (com.selfie.life.foldingcell.FoldingLibrary.animations.views.FoldingCellView foldingCellElement : foldingCellElements)
        ...
        for (int i = 0; i < foldingCellElements.size(); i++) {
            com.selfie.life.foldingcell.FoldingLibrary.animations.views.FoldingCellView cell = foldingCellElements.get(i);
     ...
     * @param animationEndListener          animation end callback
     */
    protected void startUnfoldAnimation(ArrayList<com.selfie.life.foldingcell.FoldingLibrary.animations.views.FoldingCellView> foldingCellElements, ViewGroup foldingLayout,
                                        int part90degreeAnimationDuration, AnimationEndListener animationEndListener) {
        int nextDelay = 0;
        for (int i = 0; i < foldingCellElements.size(); i++) {
            com.selfie.life.foldingcell.FoldingLibrary.animations.views.FoldingCellView cell = foldingCellElements.get(i);
